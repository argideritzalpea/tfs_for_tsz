...
print_as_test_example_from_string(source="2023 Chamoreau (ex. 50)",
                                    ...
                                    string="jimpo=sï ma ichakua musiki ni-a-ti",
                                    transl="Because this, one band will go’",
                                    orth_to_glosses_count=orth_to_glosses_count)

get_glosses_for_string("an", toolbox_data, "tph")

get_gloss_from_string("=kxï", orth_to_glosses_count)
...
orth_to_glosses_count["my"]
orth_to_glosses_count["=kxï"]

gloss_to_morphs_count["2SG.GEN"]

uichu-echa k'ui-xïn-ti=kxï
dog-PL sleep-HAB-3.ASS=3PL.S
Dogs sleep


uichu-echa antanku-a-xïn-ti=kxï motsitaɽakwa-echa-ni
dog-PL chase-3PL.OBJ-HAB-3.ASS-3PL.S car-PL-OBJ
Dogs chase cars


ref 711
1.1-2
hi=ki-ni antanku-chi-sïn-ø-ka
I=2SG.OBJ-OBJ chase-2.APL-HAB-NP-1/2ASS
I chase you